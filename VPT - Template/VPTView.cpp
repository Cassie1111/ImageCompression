...
//	ON_WM_TIMER()
	...
	ON_COMMAND(ID_EDIT_TESTAPP, &CVPTView::OnEditTestapp1)
	ON_COMMAND(ID_EDIT_TESTAPP2, &CVPTView::OnEditTestapp2)
END_MESSAGE_MAP()
...
void CVPTView::OnEditTestapp1()
{
	// TODO: Add your command handler code here
//	unsigned char *rgb ;
	CProcessing *pProc ;

	pProc = (CProcessing *) new CAppQuantize ;

	AddProcessing(pProc) ;
	DoProcessing() ;
}

void CVPTView::OnEditTestapp2()
{
	// TODO: Add your command handler code here
//	unsigned char *rgb ;
	CProcessing *pProc ;
